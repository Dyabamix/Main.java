...
class Main {
    ...
    public static class UntrustworthyMailWorker implements MailService{
        ...
        private final MailService[] mailServices = new MailService[3];
    ...
    public static class Thief implements MailService{
        private int amountOfStolenParcels;
        ...
        public Sendable processMail(Sendable mail) {
            if (mail instanceof MailPackage && ((MailPackage) mail).getContent().getPrice() >= minCost) {
                amountOfStolenParcels = getStolenValue() + ((MailPackage) mail).getContent().getPrice();
